...
window.I18N = (() => {
    ...
    const DICT = {
        'zh': {
            ...
            'mobile_upload_title': '手机图传上传', 'mobile_upload_desc': '仅真实链路：图片将通过 /api/v1/image/upload 上传并触发 AI 入库。',
            'mobile_camera': '手机拍照', 'mobile_album': '相册图片', 'mobile_clear': '清空', 'mobile_upload': '上传',
            'no_image_selected': '未选择图片', 'waiting_image': '等待图片...', 'upload_ready': '准备上传。',
            'readonly_skill_file': '只读模式协议文件', 'mobile_tag': '移动端',
            'camera_mobile_only': '拍照按钮仅支持手机端', 'camera_mobile_only_use_album': '拍照按钮仅支持手机端，请改用“相册图片”。',
            'upload_ready_mobile': '手机模式：可拍照/选图上传。', 'upload_ready_desktop': '桌面模式：支持相册上传。',
            'images_selected': '张图片', 'select_images_first': '请先选择图片。',
            'no_device_id_found': '未发现 device_id，请先注册设备或通过 ?device_id=... 打开页面。',
            'uploading': '上传中', 'upload_success': '上传成功', 'upload_partial_success': '部分成功',
            'upload_failed_kept': '失败项已保留，可重试。', 'upload_failed': '上传失败'
        },
        'en': {
            ...
            'mobile_upload_title': 'Mobile Image Upload', 'mobile_upload_desc': 'Real pipeline only: images are uploaded via /api/v1/image/upload and trigger AI ingestion.',
            'mobile_camera': 'Take Photo', 'mobile_album': 'Choose Photo', 'mobile_clear': 'Clear', 'mobile_upload': 'Upload',
            'no_image_selected': 'No image selected', 'waiting_image': 'Waiting for image...', 'upload_ready': 'Ready for upload.',
            'readonly_skill_file': 'Read-only skill protocol file', 'mobile_tag': 'MOBILE',
            'camera_mobile_only': 'Camera capture is mobile-only', 'camera_mobile_only_use_album': 'Camera is mobile-only. Please use album upload.',
            'upload_ready_mobile': 'Mobile mode: camera/album upload ready.', 'upload_ready_desktop': 'Desktop mode: album upload enabled.',
            'images_selected': 'image(s)', 'select_images_first': 'Please select image(s) first.',
            'no_device_id_found': 'No device_id found. Open with ?device_id=... or register device first.',
            'uploading': 'Uploading', 'upload_success': 'Upload success', 'upload_partial_success': 'Partial success',
            'upload_failed_kept': 'Failed items were kept for retry.', 'upload_failed': 'Upload failed'
        },
        'ms': {
            ...
            'mobile_upload_title': 'Muat Naik Imej Mudah Alih', 'mobile_upload_desc': 'Rantaian sebenar sahaja: imej dimuat naik melalui /api/v1/image/upload dan mencetuskan proses AI.',
            'mobile_camera': 'Ambil Gambar', 'mobile_album': 'Pilih Gambar', 'mobile_clear': 'Kosongkan', 'mobile_upload': 'Muat Naik',
            'no_image_selected': 'Tiada imej dipilih', 'waiting_image': 'Menunggu imej...', 'upload_ready': 'Sedia untuk dimuat naik.',
            'readonly_skill_file': 'Fail protokol kemahiran baca-sahaja', 'mobile_tag': 'MUDAH ALIH',
            'camera_mobile_only': 'Kamera hanya untuk mudah alih', 'camera_mobile_only_use_album': 'Butang kamera hanya untuk mudah alih. Sila guna album.',
            'upload_ready_mobile': 'Mod mudah alih: kamera/album sedia.', 'upload_ready_desktop': 'Mod desktop: muat naik album tersedia.',
            'images_selected': 'imej', 'select_images_first': 'Sila pilih imej terlebih dahulu.',
            'no_device_id_found': 'device_id tidak ditemui. Buka dengan ?device_id=... atau daftar peranti dahulu.',
            'uploading': 'Memuat naik', 'upload_success': 'Berjaya dimuat naik', 'upload_partial_success': 'Berjaya sebahagian',
            'upload_failed_kept': 'Item gagal dikekalkan untuk cuba semula.', 'upload_failed': 'Muat naik gagal'
        }
    };
