...
def main():
    print("\n" + "!"*60)
    print("DEPRECATION WARNING: scripts/prepare_rice_cls_dataset.py is moved.")
    print("New location: ai_engine/crops/rice/training/prepare_rice_cls_dataset.py")
    print("!"*60 + "\n")
    
    new_script = Path(__file__).parent.parent / "ai_engine" / "crops" / "rice" / "training" / "prepare_rice_cls_dataset.py"
